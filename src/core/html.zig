...
pub fn generatePlayerHtml(allocator: std.mem.Allocator, file_name: []const u8, duration: f64, codec_str: []const u8, audio_tracks_json: []const u8, start_position: f64) ![]u8 {
    ...
    var safe_file_name = std.ArrayList(u8).empty;
