...
pub fn generatePlayerHtml(allocator: std.mem.Allocator, media_query: []const u8, duration: f64, codec_str: []const u8, audio_tracks_json: []const u8, start_position: f64) ![]u8 {
