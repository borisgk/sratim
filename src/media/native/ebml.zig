...
pub const ID_SEEK = 0x4DBB;
pub const ID_SEEK_ID = 0x53AB;
pub const ID_SEEK_POSITION = 0x53AC;
pub const ID_FLAG_DEFAULT = 0x88;
pub const ID_FLAG_FORCED = 0x55AA;
pub const ID_VIDEO = 0xE0;
pub const ID_PIXEL_WIDTH = 0xB0;
pub const ID_PIXEL_HEIGHT = 0xBA;
pub const ID_DISPLAY_WIDTH = 0x54B0;
pub const ID_DISPLAY_HEIGHT = 0x54BA;
pub const ID_AUDIO = 0xE1;
pub const ID_SAMPLING_FREQUENCY = 0xB5;
pub const ID_CHANNELS = 0x9F;
pub const ID_BIT_DEPTH = 0x6264;
