...
pub const LogsStorage = struct {
    ...
    pub fn writeLock(self: *LogsStorage) void {
        self.rwlock.lockUncancelable(self.io);
    }
    pub fn writeUnlock(self: *LogsStorage) void {
        self.rwlock.unlock(self.io);
    }
    pub fn readLock(self: *LogsStorage) void {
        self.rwlock.lockSharedUncancelable(self.io);
    }
    pub fn readUnlock(self: *LogsStorage) void {
        self.rwlock.unlockShared(self.io);
    }

    pub fn now(self: *const LogsStorage) i64 {
    ...
    // WAL & Snapshot delegation
    pub const snapshotLocked = logs_wal.snapshotLocked;
    pub const snapshot = logs_wal.snapshot;
    pub const writeWalRecord = logs_wal.writeWalRecord;
    pub const writeWalSavePlaybackProgress = logs_wal.writeWalSavePlaybackProgress;
    pub const writeWalSaveEpisodePlaybackProgress = logs_wal.writeWalSaveEpisodePlaybackProgress;
    pub const writeWalDeletePlaybackProgress = logs_wal.writeWalDeletePlaybackProgress;
    pub const writeWalDeleteEpisodePlaybackProgress = logs_wal.writeWalDeleteEpisodePlaybackProgress;
    pub const writeWalLogPlaybackEvent = logs_wal.writeWalLogPlaybackEvent;
    pub const writeWalLogEpisodePlaybackEvent = logs_wal.writeWalLogEpisodePlaybackEvent;
    pub const writeWalLogLoginAttempt = logs_wal.writeWalLogLoginAttempt;
    pub const writeWalClearFailedLogins = logs_wal.writeWalClearFailedLogins;
    pub const applyWalPayload = logs_wal.applyWalPayload;
    pub const replayWal = logs_wal.replayWal;
    pub const loadSnapshot = logs_wal.loadSnapshot;
    pub const load = logs_wal.load;
